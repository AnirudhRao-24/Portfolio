  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      if (gameState === 'start') {
        ...
        ctx.fillText('PRESS SPACE/TAP TO START', CANVAS_WIDTH / 2, CANVAS_HEIGHT / 2 + 50);
        ctx.fillText('P1: ARROWS/GAMEPAD', CANVAS_WIDTH / 4, CANVAS_HEIGHT / 2 + 100);
