  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      if (gameState === 'start') {
        ...
        ctx.fillText('USE ARROWS / GAMEPAD', CANVAS_WIDTH / 2, CANVAS_HEIGHT / 2 + 40);
      }
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-full p-4 relative font-mono">
      ...
      <canvas 
        ...
        className="bg-[#111] border border-[#333] shadow-[0_0_50px_rgba(0,0,0,0.8)] max-w-[90vw] max-h-[60vh] object-contain rounded-lg" 
      />
      <MobileGamepad up down left right action />
    </div>
  );
};
